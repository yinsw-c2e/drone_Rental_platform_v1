...
(1, '13800138000', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '系统管理员', '', 'admin', 'approved', 100, 'active', NOW(), NOW()),
(2, '13800138001', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '张三', 'https://picsum.photos/200?random=1', 'drone_owner', 'approved', 95, 'active', NOW(), NOW()),
(3, '13800138002', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '李四', 'https://picsum.photos/200?random=2', 'drone_owner', 'approved', 98, 'active', NOW(), NOW()),
(4, '13800138003', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '王五', 'https://picsum.photos/200?random=3', 'renter', 'approved', 92, 'active', NOW(), NOW()),
(5, '13800138004', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '赵六', 'https://picsum.photos/200?random=4', 'renter', 'approved', 88, 'active', NOW(), NOW()),
(6, '13800138005', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '钱七', 'https://picsum.photos/200?random=5', 'both', 'pending', 100, 'active', NOW(), NOW()),
(7, '13800138006', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '孙八', 'https://picsum.photos/200?random=6', 'drone_owner', 'approved', 96, 'active', NOW(), NOW()),
(8, '13800138007', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '周九', 'https://picsum.photos/200?random=7', 'renter', 'rejected', 85, 'active', NOW(), NOW());
