...
// @Router /api/v2/credit/my-score [get]
...
// @Success 200 {object} model.CreditScore
// @Router /api/v2/credit/user/{user_id} [get]
...
// @Router /api/v2/credit/scores [get]
...
// @Param page_size query int false "每页数量"
// @Success 200 {object} response.PageResponse
// @Router /api/v2/credit/my-logs [get]
...
// @Param page_size query int false "每页数量"
// @Success 200 {object} response.PageResponse
// @Router /api/v2/credit/my-violations [get]
...
// @Param page_size query int false "每页数量"
// @Success 200 {object} response.PageResponse
// @Router /api/v2/credit/violations [get]
...
// @Router /api/v2/credit/violations/{id} [get]
...
// @Success 200 {object} model.Violation
// @Router /api/v2/credit/violations [post]
...
// @Router /api/v2/credit/violations/{id}/confirm [post]
...
// @Success 200 {string} string "success"
// @Router /api/v2/credit/violations/{id}/appeal [post]
...
// @Success 200 {string} string "success"
// @Router /api/v2/credit/violations/{id}/review-appeal [post]
...
// @Param page_size query int false "每页数量"
// @Success 200 {object} response.PageResponse
// @Router /api/v2/credit/risks [get]
...
// @Router /api/v2/credit/risks/{id} [get]
...
// @Success 200 {object} model.RiskControl
// @Router /api/v2/credit/risk-check [get]
...
// @Success 200 {string} string "success"
// @Router /api/v2/credit/risks/{id}/review [post]
...
// @Param page_size query int false "每页数量"
// @Success 200 {object} response.PageResponse
// @Router /api/v2/credit/blacklists [get]
...
// @Router /api/v2/credit/my-deposit [get]
...
// @Param page_size query int false "每页数量"
// @Success 200 {object} response.PageResponse
// @Router /api/v2/credit/deposits [get]
...
// @Success 200 {object} model.Deposit
// @Router /api/v2/credit/deposits [post]
...
// @Router /api/v2/credit/statistics [get]
