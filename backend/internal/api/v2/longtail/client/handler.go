...
// POST /api/v2/client/register/individual
...
// POST /api/v2/client/register/enterprise
...
// UpdateDemand 更新草稿需求
// PATCH /api/v2/client/demands/:id
...
// PublishDemand 发布需求
// POST /api/v2/client/demands/:id/publish
...
// CancelDemand 取消需求
// POST /api/v2/client/demands/:id/cancel
...
// GET /api/v2/client/demands/:id/quotes
...
// POST /api/v2/client/demands/:id/select-provider
...
// POST /api/v2/client/credit/check
...
// GET /api/v2/client/credit/history
...
// POST /api/v2/client/enterprise/cert
...
// GET /api/v2/client/enterprise/certs
...
// POST /api/v2/client/cargo/declaration
...
// GET /api/v2/client/cargo/declaration/:id
...
// GET /api/v2/client/cargo/declarations
...
// PUT /api/v2/client/cargo/declaration/:id
...
// GET /api/v2/client/order/eligibility
...
// POST /api/v2/client/admin/approve/:id
...
// POST /api/v2/client/admin/reject/:id
...
// POST /api/v2/client/admin/cert/approve/:id
...
// POST /api/v2/client/admin/cert/reject/:id
...
// POST /api/v2/client/admin/cargo/approve/:id
...
// POST /api/v2/client/admin/cargo/reject/:id
...
// GET /api/v2/client/admin/pending
...
// GET /api/v2/client/admin/cargo/pending
