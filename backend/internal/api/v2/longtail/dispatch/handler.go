...
// GET /api/v2/dispatch/task/no/:taskNo
...
// GET /api/v2/dispatch/tasks/client
...
// CancelTask 取消任务
// POST /api/v2/dispatch/task/:id/cancel
...
// GET /api/v2/dispatch/task/:id/candidates
...
// GetTaskLogs 获取任务日志
// GET /api/v2/dispatch/task/:id/logs
...
// GET /api/v2/dispatch/tasks/pilot
...
// GET /api/v2/dispatch/task/pending
...
// AcceptTask 接受任务
// POST /api/v2/dispatch/candidate/:id/accept
...
// RejectTask 拒绝任务
// POST /api/v2/dispatch/candidate/:id/reject
...
// GET /api/v2/dispatch/order/active
...
// POST /api/v2/dispatch/order/:id/status
...
// ManualMatch 手动触发匹配
// POST /api/v2/dispatch/task/:id/match
...
// POST /api/v2/dispatch/admin/process
...
// POST /api/v2/dispatch/admin/handle-expired
