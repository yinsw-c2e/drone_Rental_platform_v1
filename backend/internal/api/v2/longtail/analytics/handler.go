...
// POST /api/v2/analytics/dashboard/refresh
...
// GetTrendData 获取趋势数据
// GET /api/v2/analytics/trends?days=7
...
// GET /api/v2/analytics/daily?date=2026-03-01
...
// GET /api/v2/analytics/daily/range?start=2026-03-01&end=2026-03-07
...
// POST /api/v2/analytics/admin/daily/generate
...
// GetReport 获取报表详情
// GET /api/v2/analytics/report/:id
...
// GET /api/v2/analytics/report/no/:reportNo
...
// GET /api/v2/analytics/reports?type=daily&page=1&page_size=10
...
// GET /api/v2/analytics/report/latest/:type
...
// DeleteReport 删除报表
// DELETE /api/v2/analytics/report/:id
...
// GET /api/v2/analytics/heatmap?type=order_density&date=2026-03-01
...
// GET /api/v2/analytics/regions?date=2026-03-01
...
// GET /api/v2/analytics/regions/top?date=2026-03-01&limit=10
...
// GET /api/v2/analytics/hourly?hours=24
...
// POST /api/v2/analytics/admin/job/daily
...
// POST /api/v2/analytics/admin/job/hourly
...
// POST /api/v2/analytics/admin/job/report
