...
func buildOrderSummary(order *model.Order) gin.H {
	...
	return gin.H{
		...
		"service_latitude":       order.ServiceLatitude,
		"service_longitude":      order.ServiceLongitude,
		"dest_address":           order.DestAddress,
		"dest_latitude":          order.DestLatitude,
		"dest_longitude":         order.DestLongitude,
		...
		"loading_confirmed_at":   order.LoadingConfirmedAt,
