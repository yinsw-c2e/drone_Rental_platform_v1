...
| 飞手（公开派单） | `13900000017` | 陈飞手样本账号 | 公共飞手池邀请、正式派单确认、执行验收 |
...
### 3.4 飞手（公开派单） `13900000017`

- 昵称：`陈飞手`
- 可直接使用密码 `password123` 或验证码登录
- 当前佛山禅城直达下单样本在扩展到普通飞手池时，会优先邀请该账号
- 当订单详情出现“已邀请陈飞手确认执行”时，应切换到这个账号继续验收

### 3.5 复合身份 `13800000002`
