...
const getStyles = (theme: AppTheme) => StyleSheet.create({
  ...
  createBtn: {backgroundColor: theme.primary, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 999},
  createBtnText: {color: theme.btnPrimaryText, fontSize: 13, fontWeight: '700'},
  listContent: {padding: 16},
  card: {backgroundColor: theme.card, borderRadius: 16, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: theme.cardBorder, shadowColor: '#000', shadowOffset: {width: 0, height: 2}, shadowOpacity: 0.04, shadowRadius: 8, elevation: 2},
  ...
  cancelBtn: {backgroundColor: theme.inputBg, borderWidth: 1, borderColor: theme.cardBorder},
  ...
  formCard: {backgroundColor: theme.card, borderRadius: 20, padding: 18, marginBottom: 16, borderWidth: 1, borderColor: theme.cardBorder},
  formSectionTitle: {fontSize: 16, fontWeight: '700', color: theme.text, marginBottom: 12},
  label: {fontSize: 13, color: theme.textSub, marginBottom: 6, marginTop: 8},
  input: {backgroundColor: theme.inputBg, borderWidth: 1, borderColor: theme.inputBorder, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14, color: theme.text},
  textArea: {minHeight: 80, textAlignVertical: 'top'},
  optionRow: {flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 4},
  optionChip: {paddingHorizontal: 14, paddingVertical: 8, borderRadius: 999, backgroundColor: theme.inputBg, borderWidth: 1, borderColor: theme.inputBorder},
  ...
  addrField: {
    borderWidth: 1, borderColor: theme.inputBorder, borderRadius: 12,
    paddingHorizontal: 14, paddingVertical: 14, backgroundColor: theme.inputBg,
    justifyContent: 'center', minHeight: 48,
  },
  timePickerRow: {flexDirection: 'row', gap: 12, marginTop: 8, marginBottom: 16},
  timeBox: {flex: 1, backgroundColor: theme.inputBg, borderRadius: 16, padding: 14, borderWidth: 1, borderColor: theme.inputBorder},
