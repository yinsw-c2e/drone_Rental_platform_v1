...
const getStyles = (theme: AppTheme) => StyleSheet.create({
  ...
  content: {padding: 12, paddingBottom: 100, gap: 12},
  ...
  title: {marginTop: 12, fontSize: 20, lineHeight: 27, color: theme.text, fontWeight: '700'},
  ...
  gridItem: {flex: 1, alignItems: 'center', backgroundColor: theme.inputBg, borderRadius: 14, paddingVertical: 12, paddingHorizontal: 8},
